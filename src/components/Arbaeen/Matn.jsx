...
const data = [
  ...
  },
  {
    ...
    english: {
      narrator: "On the authority of Abdullah ibn Masood (ra), who said:",
  ...
  },
  {
    ...
    english: {
      ...
      text: "The Messenger of Allah (ﷺ) said, “He who innovates something in this matter of ours (i.e., Islam) that is not of it will have it rejected (by Allah).”\n\n\nIn another version in Muslim it reads: “He who does an act which we have not commanded, will have it rejected (by Allah).”",
    },
  },
  {
    id: 40949,
    ...
    english: {
      narrator: "On the authority of an-Nu’man ibn Basheer (ra), who said:",
  ...
  },
  {
    ...
    english: {
      ...
      text: "The Prophet (ﷺ) said, “The deen (religion) is naseehah (advice, sincerity).” We said, “To whom?” He (ﷺ) said, “To Allah, His Book, His Messenger, and to the leaders of the Muslims and their common folk.”\n\n",
    },
  },
  {
    id: 40951,
  ...
  },
  {
    ...
    english: {
      ...
      text: "I heard the Messenger of Allah (ﷺ) say, “What I have forbidden for you, avoid. What I have ordered you  who were before you.”\n\n",
    },
  },
  {
    id: 40953,
    ...
    english: {
      narrator: "On the authority of Abu Hurayrah (ra):",
      text: "The Messenger of Allah (ﷺ) said, “Allah the Almighty is Good and accepts only that which is good. And verily Allah has commanded the believers to do that which He has commanded the Messengers.\n\nSo the Almighty has said: “O (you) Messengers! Eat of the tayyibat ”\n\nThen he (ﷺ) mentioned  be answered?\n\n",
    },
  },
  {
    id: 40954,
    ...
    english: {
      ...
      text: "I memorised from the Messenger of Allah (peace and blessings of Allah be upon him): “Leave that which makes you doubt for that which does not make you doubt.”\n\n\n\nAt-Tirmidhi said that it was a good and sound (hasan saheeh) hadeeth.",
    },
  },
  {
    id: 40955,
    ...
    english: {
      ...
      text: "The Messenger of Allah (peace and blessings of Allah be upon him) said, “Part of the perfection of one’s Islam is his leaving that which does not concern him.”\n\nA hasan (good) hadeeth which was related by at-Tirmidhi and others in this fashion.",
    },
  },
  {
    id: 40956,
    ...
    english: {
      ...
      text: "None of you  believes until he loves for his brother that which he loves for himself. \n\n\n",
    },
  },
  {
    id: 40957,
    ...
    english: {
      ...
      text: "The Messenger of Allah (peace and blessings of Allah be upon him) said, “It is not permissible to spill the blood of a Muslim except in three : the married person who commits adultery, a life for a life, and the one who forsakes his religion and separates from the community.”\n\n\n",
    },
  },
  {
    id: 40958,
    ...
    english: {
      ...
      text: "Let him who believes in Allah and the Last Day speak good, or keep silent; and let him who believes in Allah and the Last Day be generous to his neighbour; and let him who believes in Allah and the Last Day be generous to his guest.\n\n\n",
    },
  },
  {
    id: 40959,
    ...
    english: {
      ...
      text: "A man said to the Prophet (peace and blessings of Allah be upon him), “Counsel me,” so he (peace and blessings of Allah be upon him) said, “Do not become angry.” The man repeated  he (peace and blessings of Allah be upon him) said, “Do not become angry.”\n\n",
    },
  },
  {
    id: 40960,
  ...
  },
  {
    ...
    english: {
      ...
      text: "The Messenger of Allah (peace and blessings of Allah be upon him) said, “Verily, from what was learnt by the people from the speech of the earliest prophecy is: If you feel no shame, then do as you wish.”\n\n",
    },
  },
  {
    id: 40964,
    ...
    english: {
      ...
      text: 'I said, "O Messenger of Allah, tell me something about al-Islam which I can ask of no one but you." He (peace and blessings of Allah be upon him) said, "Say I believe in Allah — and then be steadfast."\n\n',
    },
  },
  {
    id: 40965,
  ...
  },
  {
    ...
    english: {
      ...
      text: "Were people to be given everything that they claimed, men would  people. But, the onus of proof is upon the claimant, and the taking of an oath is upon him who denies.\n\nA hasan hadeeth narrated by al-Baihaqee and others in this form, and part of it is in the two Saheehs.",
    },
  },
  {
    id: 40977,
    ...
    english: {
      ...
      text: "I heard the Messenger of Allah (ﷺ) say, “Whosoever of you sees an evil, let him change it with his hand; and if he is not able to do so, then  with his tongue; and if he is not able to do so, then with his heart — and that is the weakest of faith.”\n\n",
    },
  },
  {
    id: 40978,
  ...
  },
  {
    ...
    english: {
      ...
      text: "Verily Allah ta’ala has written down the good deeds and the evil deeds, and then explained it  and then performed it, then Allah writes it down as one evil deed.”\n\n\n.",
    },
  },
  {
    id: 40981,
  ...
  },
  {
    ...
    english: {
      narrator:
        "On the authority of Ibn Abbas (may Allah be pleased with him), that the Messenger of Allah (peace and blessings of Allah be upon him) said:",
      text: "Verily Allah has pardoned  for me my ummah: their mistakes, their forgetfulness, and that which they have been forced to do under duress.\n\nA hasan hadeeth related by Ibn Majah, and al-Bayhaqee and others.",
    },
  },
  {
    id: 40983,
    ...
    english: {
      ...
      text: "The Messenger of Allah (peace and blessings of Allah be upon him) took me by the shoulder and said, “Be in this world as though you were a stranger or a wayfarer.”\n\nAnd Ibn Umar (may Allah be pleased with him) used to say, “In the evening do not expect  your life before your death.”\n\n",
    },
  },
  {
    id: 40984,
    ...
    english: {
      ...
      text: "The Messenger of Allah (peace and blessings of Allah be upon him) said, “None of you  believes until his desires are subservient to that which I have brought.”\n\n We have related it in Kitab al-Hujjah with a saheeh chain of narrators.",
    },
  },
  {
    id: 40985,
...
export default function Matn({ currentHadith }) {
  const [showTrnsl, setShowTrnsl] = useState(false);

  return (
    <div className="rounded-md bg-[#f4f4f4] p-4 md:col-span-2 dark:text-white dark:bg-[#272729]">
      <div className="flex justify-between items-center mb-4">
        <span className="font-extralight font-sans block text-sm">
          Current Hadith Number: {currentHadith + 1}
        </span>
        <button
          onClick={() => setShowTrnsl(!showTrnsl)}
          className="text-sm font-medium bg-white p-2 rounded-md dark:bg-[#878787]"
        >
          Show {!showTrnsl ? "Translation" : "Arabic"}
        </button>
      </div>
      {showTrnsl ? (
        <span className="">
          {data[currentHadith]?.english.narrator}
          {data[currentHadith]?.english.text}
        </span>
      ) : (
        <div className="font-kitab leading-10 text-xl text-right">
          {data[currentHadith]?.arabic}
        </div>
      )}
    </div>
  );
